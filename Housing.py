...
class App():
    # Change the file path of train and test.
    # Also please change submission file path inside _submission() function defined below.
    def __init__(self): 
        # Loads the dataset.
        # Change the file path of train and test.
        # Also please change submission file path inside _submission() function defined below.

        file_train = "/CSUF/CPSC 483/Project 2/train.csv"
        file_test = "/CSUF/CPSC 483/Project 2/test.csv"
    ...
    """
    Please change submission file path inside _submission() function defined below.
    """
